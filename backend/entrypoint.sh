...
sam local start-api --docker-volume-basedir $basedir --host 0.0.0.0 --port 5000 "${args[@]}" --parameter-overrides \
ParameterKey=FrontendUrl,ParameterValue=$frontend_url ParameterKey=UserPoolArn,ParameterValue=$user_pool_arn
